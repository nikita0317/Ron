...
const Home = () => {
    ...
    return (
      <Box>
        ...
        <Box
            className='leader-board-container'
        >
            <Box className='leader-board-card'>
                ...
                >
                    ...
                    <Box>
                        <img src='images/awards/crown.png' alt='Award Crown Logo'/><br/>
                                    ...
                                    <>
                                        <Box className='award-lists-item'>
                                            <Box
                                                ...
                                                gap={2}
                                            >
                                                <Box className="award-lists-item-number">
                                                    { item.id }
                                                </Box>
            ...
            <Typography color='white' className='comments'>
                *Awards are delivered in money according to the sum shown next to it and in any way you choose to redeem it via Plum: cash, gift card, or a prepaid credit card (depending on what's available via Plum in your country and your voucher's sum).
            </Typography>
        </Box>
